...
namespace BattleSimulator.UIScripts
{
    public class SimulationUI : MonoBehaviour
    {
        ...
        public GameObject soldierSettingsMenu;
        ...
        public bool soldierSettingsMenuActive;
        ...
        void Awake() {
            ...
            soldierSettingsMenuActive = false;
        ...
        void DisableActivePlayerInteractionMenus() {
            ...
            if (soldierSettingsMenuActive) {
                soldierSettingsMenuActive = false;
                soldierSettingsMenu.SetActive(false);
            }
        }

        bool PlayerInteractionMenuIsActive() {
            if (sundererSettingsMenuActive || soldierSettingsMenuActive) {
                return true;
            } else {
                return false;
            }
        ...
        public void ToggleSundererSettingsMenu() {
            if (!escapeMenuActive && !sundererSettingsMenuActive && !soldierSettingsMenuActive) {
                Cursor.lockState = CursorLockMode.None;
        ...
        public void ToggleSoldierSettingsMenu() {
            if (!escapeMenuActive && !sundererSettingsMenuActive && !soldierSettingsMenuActive) {
                Cursor.lockState = CursorLockMode.None;
                currentActiveMenu = soldierSettingsMenu;
                soldierSettingsMenuActive = true;
                soldierSettingsMenu.SetActive(true);
            } else if (!escapeMenuActive) {
                Cursor.lockState = CursorLockMode.Locked;
                currentActiveMenu = null;
                soldierSettingsMenuActive = false;
